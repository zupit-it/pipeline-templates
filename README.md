...
jobs:
    build-and-push-image:
        uses: zupit-it/pipeline-templates/.github/workflows/node-step-docker-build-and-push-image.yml@v1.23.1
        with:
...
steps:
    ...
    - name: Build & Push Docker
      id: docker
      uses: zupit-it/pipeline-templates/.github/actions/docker/build-and-push@v1.23.1
      with:
          REGISTRY_URL: ghcr.io
...
steps:
    - name: Install .NET
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/install@v1.23.1
      with:
...
steps:
    - name: Build
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/build@v1.23.1
      with:
          WORKING_DIRECTORY: "back-end"
...
steps:
    - name: Build
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/format@v1.23.1
      with:
          WORKING_DIRECTORY: "back-end"
          SHELL: "bash"
...
steps:
    - name: Build
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/lint@v1.23.1
      with:
...
steps:
    - name: Run tests
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/test@v1.23.1
      with:
          WORKING_DIRECTORY: "back-end"
...
steps:
    - name: Build
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/release@v1.23.1
      with:
          WORKING_DIRECTORY: "back-end"
          BUILD_CONFIG: "Release"
          PROJECT: "My.Api/My.Api.csproj"
...
steps:
    - name: Publish to Azure App Service
      uses: zupit-it/pipeline-templates/.github/actions/azure/app-service/deploy@v1.23.1
      with:
          WORKING_DIRECTORY: "back-end"
...
steps:
    - name: Deploy to Azure Storage
      uses: zupit-it/pipeline-templates/.github/actions/azure/storage/deploy@v1.23.1
      with:
...
steps:
    - name: Deploy to IIS
      uses: zupit-it/pipeline-templates/.github/actions/iis/deploy@v1.23.1
      with:
...
```yaml
  - name: Generate artifact name
    id: artifact-name
    uses: zupit-it/pipeline-templates/.github/actions/artifact/generate-name@v1.23.1
    with:
  ...
  - name: Upload build artifact
    uses: zupit-it/pipeline-templates/.github/actions/artifact/upload@v1.23.1
    with:
...
steps:
    - name: Download artifact
      uses: zupit-it/pipeline-templates/.github/actions/artifact/download@v1.23.1
      with:
          ARTIFACT_NAME: my-artifact-name
```
...
```yaml
    - name: Create archive
      uses: zupit-it/pipeline-templates/.github/actions/artifact/create-archive@v1.23.1
      with:
          SOURCE_FOLDER: my-source-folder
...
```yaml
    - name: Extract archive
      uses: zupit-it/pipeline-templates/.github/actions/artifact/extract-archive@v1.23.1
      with:
...
jobs:
    node-common:
        uses: zupit-it/pipeline-templates/.github/workflows/node-workflow-common.yml@v1.23.1
        with:
            WORKING_DIRECTORY: frontend
            NODE_VERSION: 16.17.0
...
jobs:
    build-and-push-image:
        uses: zupit-it/pipeline-templates/.github/workflows/node-step-azure-storage-build-and-deploy.yml@v1.23.1
        with:
            WORKING_DIRECTORY: front-end
            NODE_VERSION: "16.17.0"
            RELEASE_ENVIRONMENT: testing
...
jobs:
    django-common:
        uses: zupit-it/pipeline-templates/.github/workflows/django-workflow-common.yml@v1.23.1
        with:
            WORKING_DIRECTORY: backend
...
jobs:
    java-common:
        uses: zupit-it/pipeline-templates/.github/workflows/springboot-workflow-common.yml@v1.23.1
        with:
            WORKING_DIRECTORY: backend
...
jobs:
    springboot-build-and-push-image:
        ...
        uses: zupit-it/pipeline-templates/.github/workflows/springboot-step-docker-build-and-push-image.yml@v1.23.1
        with:
            JAVA_IMAGE: openjdk:12
            RELEASE_ENVIRONMENT: testing
            WORKING_DIRECTORY: backend
...
jobs:
    common:
        uses: zupit-it/pipeline-templates/.github/workflows/dotnet-workflow-common.yml@v1.23.1
        with:
            WORKING_DIRECTORY: "backend"
...
jobs:
    build-and-push-image:
        uses: zupit-it/pipeline-templates/.github/workflows/docker-step-build-and-push-image.yml@v1.23.1
        with:
            RELEASE_ENVIRONMENT: testing
            WORKING_DIRECTORY: backend
            REGISTRY_URL: ghcr.io
...
jobs:
    deploy:
        uses: zupit-it/pipeline-templates/.github/workflows/docker-step-deploy.yml@v1.23.1
        with:
...
jobs:
    clean-ionic-images:
        uses: zupit-it/pipeline-templates/.github/workflows/docker-step-delete-images.yml@v1.23.1
        with:
            IMAGE_NAME: "ionic"
        secrets: inherit
```
...
jobs:
    jira-move-issue-to-developed:
        uses: zupit-it/pipeline-templates/.github/workflows/jira-step-move-issue.yml@v1.23.1
        with:
            STATUS: Developed
...
jobs:
    lint-pr:
        uses: zupit-it/pipeline-templates/.github/workflows/conventional-commits-step-lint.yml@v1.23.1
        with:
...
jobs:
    lint-pr:
        uses: zupit-it/pipeline-templates/.github/workflows/conventional-commits-step-release.yml@v1.23.1
        secrets: inherit
```
...
jobs:
    angular-sonar-analyze:
        uses: zupit-it/pipeline-templates/.github/workflows/sonar-step-analyze.yml@v1.23.1
        with:
            WORKING_DIRECTORY: frontend
...
jobs:
    sonar-analyze:
        uses: zupit-it/pipeline-templates/.github/workflows/sonar-step-dotnet-analyze.yml@v1.23.1
        with:
            WORKING_DIRECTORY: "back-end"
