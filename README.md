...
jobs:
    build-and-push-image:
        uses: zupit-it/pipeline-templates/.github/workflows/node-step-docker-build-and-push-image.yml@v1.11.2
        with:
...
steps:
    ...
    - name: Build & Push Docker
      id: docker
      uses: zupit-it/pipeline-templates/.github/actions/docker/build-and-push@v1.11.2
      with:
          REGISTRY_URL: ghcr.io
...
steps:
    - name: Install .NET
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/install@v1.11.2
      with:
...
steps:
    - name: Build
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/build@v1.11.2
      with:
          WORKING_DIRECTORY: "back-end"
...
steps:
    - name: Build
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/format@v1.11.2
      with:
          WORKING_DIRECTORY: "back-end"
          SHELL: "bash"
...
steps:
    - name: Build
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/lint@v1.11.2
      with:
...
steps:
    - name: Run tests
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/test@v1.11.2
      with:
          WORKING_DIRECTORY: "back-end"
...
steps:
    - name: Build
      uses: zupit-it/pipeline-templates/.github/actions/dotnet/release@v1.11.2
      with:
          WORKING_DIRECTORY: "back-end"
          BUILD_CONFIG: "Release"
          PROJECT: "My.Api/My.Api.csproj"
...
steps:
    - name: Publish to Azure App Service
      uses: zupit-it/pipeline-templates/.github/actions/azure/app-service/deploy@v1.11.2
      with:
          WORKING_DIRECTORY: "back-end"
...
steps:
    - name: Deploy to Azure Storage
      uses: zupit-it/pipeline-templates/.github/actions/azure/storage/deploy@v1.11.2
      with:
...
steps:
    - name: Deploy to IIS
      uses: zupit-it/pipeline-templates/.github/actions/iis/deploy@v1.11.2
      with:
...
```yaml
  - name: Generate artifact name
    id: artifact-name
    uses: zupit-it/pipeline-templates/.github/actions/artifact/generate-name@v1.11.2
    with:
  ...
  - name: Upload build artifact
    uses: zupit-it/pipeline-templates/.github/actions/artifact/upload@v1.11.2
    with:
...
steps:
    - name: Download artifact
      uses: zupit-it/pipeline-templates/.github/actions/artifact/download@v1.11.2
      with:
          ARTIFACT_NAME: my-artifact-name
```
...
```yaml
    - name: Create archive
      uses: zupit-it/pipeline-templates/.github/actions/artifact/create-archive@v1.11.2
      with:
          SOURCE_FOLDER: my-source-folder
...
```yaml
    - name: Extract archive
      uses: zupit-it/pipeline-templates/.github/actions/artifact/extract-archive@v1.11.2
      with:
...
jobs:
    node-common:
        uses: zupit-it/pipeline-templates/.github/workflows/node-workflow-common.yml@v1.11.2
        with:
...
jobs:
    build-and-push-image:
        uses: zupit-it/pipeline-templates/.github/workflows/node-step-azure-storage-build-and-deploy.yml@v1.11.2
        with:
...
jobs:
    django-common:
        uses: zupit-it/pipeline-templates/.github/workflows/django-workflow-common.yml@v1.11.2
        with:
            WORKING_DIRECTORY: backend
...
jobs:
    java-common:
        uses: zupit-it/pipeline-templates/.github/workflows/springboot-workflow-common.yml@v1.11.2
        with:
            NATIVE_CI_LABELS: "['pinga', 'pipeline', 'native']"
            CONTAINER_CI_LABELS: "['pinga', 'pipeline', 'container']"
            WORKING_DIRECTORY: backend
...
jobs:
    springboot-build-and-push-image:
        ...
        uses: zupit-it/pipeline-templates/.github/workflows/springboot-step-docker-build-and-push-image.yml@v1.11.2
        with:
            LABELS: "['pinga', 'pipeline', 'container']"
            JAVA_IMAGE: openjdk:12
            RELEASE_ENVIRONMENT: testing
...
jobs:
    common:
        uses: zupit-it/pipeline-templates/.github/workflows/dotnet-workflow-common.yml@v1.11.2
        with:
            WORKING_DIRECTORY: "backend"
...
jobs:
    build-and-push-image:
        uses: zupit-it/pipeline-templates/.github/workflows/docker-step-build-and-push-image.yml@v1.11.2
        with:
...
jobs:
    deploy:
        uses: zupit-it/pipeline-templates/.github/workflows/docker-step-deploy.yml@v1.11.2
        with:
...
jobs:
    clean-ionic-images:
        uses: zupit-it/pipeline-templates/.github/workflows/docker-step-delete-images.yml@v1.11.2
        with:
            LABELS: "['pinga', 'pipeline', 'native']"
            IMAGE_NAME: "ionic"
        secrets: inherit
...
jobs:
    jira-move-issue-to-developed:
        uses: zupit-it/pipeline-templates/.github/workflows/jira-step-move-issue.yml@v1.11.2
        with:
            LABELS: "['pinga', 'pipeline', 'native']"
            STATUS: Developed
...
jobs:
    lint-pr:
        uses: zupit-it/pipeline-templates/.github/workflows/conventional-commits-step-lint.yml@v1.11.2
        with:
            LABELS: "['pinga', 'pipeline', 'native']"
...
jobs:
    lint-pr:
        uses: zupit-it/pipeline-templates/.github/workflows/conventional-commits-step-release.yml@v1.11.2
        with:
            LABELS: "['pinga', 'pipeline', 'native']"
        secrets: inherit
```
...
jobs:
    angular-sonar-analyze:
        uses: zupit-it/pipeline-templates/.github/workflows/sonar-step-analyze.yml@v1.11.2
        with:
            WORKING_DIRECTORY: frontend
...
jobs:
    sonar-analyze:
        uses: zupit-it/pipeline-templates/.github/workflows/sonar-step-dotnet-analyze.yml@v1.11.2
        with:
            CONTAINER_CI_LABELS: "['team', 'pipeline', 'container']"
            WORKING_DIRECTORY: "back-end"
