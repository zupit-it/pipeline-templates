...
## Workflows
Here we list the standard workflows to use with the examples of how to use them.
...
#### Common
**django-workflow-common.yml** is the reusable workflow that groups together these reusable workflows:
...
#### Common
**node-workflow-common.yml** is the reusable workflow that groups together these reusable workflows:
